...
# Form implementation generated from reading ui file 'D:/yjc/USD/pxr/usdImaging/usdviewq/adjustDefaultMaterialUI.ui',
# licensing of 'D:/yjc/USD/pxr/usdImaging/usdviewq/adjustDefaultMaterialUI.ui' applies.
#
# Created: Thu Apr  6 11:40:16 2023
...
class Ui_AdjustDefaultMaterial(object):
    def setupUi(self, AdjustDefaultMaterial):
        ...
        self.verticalLayout = QtWidgets.QVBoxLayout(AdjustDefaultMaterial)
        ...
        self.ambientInt = QtWidgets.QLabel(AdjustDefaultMaterial)
        ...
        self.ambientIntSpinBox = QtWidgets.QDoubleSpinBox(AdjustDefaultMaterial)
        ...
        self.specularInt = QtWidgets.QLabel(AdjustDefaultMaterial)
        ...
        self.specularIntSpinBox = QtWidgets.QDoubleSpinBox(AdjustDefaultMaterial)
        ...
        self.resetButton = QtWidgets.QPushButton(AdjustDefaultMaterial)
        ...
        self.doneButton = QtWidgets.QPushButton(AdjustDefaultMaterial)
    ...
    def retranslateUi(self, AdjustDefaultMaterial):
        AdjustDefaultMaterial.setWindowTitle(QtWidgets.QApplication.translate("AdjustDefaultMaterial", "Adjust Default Material", None, -1))
        AdjustDefaultMaterial.setProperty("comment", QtWidgets.QApplication.translate("AdjustDefaultMaterial", "\n"
...
"  ", None, -1))
        self.ambientInt.setText(QtWidgets.QApplication.translate("AdjustDefaultMaterial", "Ambient Intensity", None, -1))
        self.specularInt.setText(QtWidgets.QApplication.translate("AdjustDefaultMaterial", "Specular Intensity", None, -1))
        self.resetButton.setText(QtWidgets.QApplication.translate("AdjustDefaultMaterial", "Reset", None, -1))
        self.doneButton.setText(QtWidgets.QApplication.translate("AdjustDefaultMaterial", "Done", None, -1))
